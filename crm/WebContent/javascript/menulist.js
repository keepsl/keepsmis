...
$(function(){
	...
	grid = [
		...
		{"hidden":false,"align":"left","sortable":true,"width":150,"name":"url","resizable":true,"label":"菜单连接"},
		{"hidden":false,"align":"left","sortable":true,"width":80,"name":"icon","resizable":true,"label":"样式名"},
		{"hidden":false,"align":"left","sortable":true,"width":60,"name":"status","resizable":true,"label":"状态",formatter:function(cellvalue, options, rowObject){
			if(cellvalue==1){
				return '启用';
			}else{
				return '禁用';
		...
		{"hidden":false,"align":"left","sortable":true,"width":130,"name":"createtime","resizable":true,"label":"创建时间",formatter:function(cellValue, options, rowObject){
