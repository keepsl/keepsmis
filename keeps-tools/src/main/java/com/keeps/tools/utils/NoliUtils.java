 ...
 * @author keeps
 * @version v 1.00
 * @date 创建日期：2017年6月18日 修改日期： 修改人： 复审人：
 */
public class NoliUtils {
	private int year;
	private int month;
	private int day;
	...
	public static Date getNoliDate(Date date) {
		int yearCyl, monCyl, dayCyl;
		int leapMonth = 0;
		Date baseDate = null;
		Calendar cal = Calendar.getInstance();
		...
		int day = offset + 1;
		return DateUtils.parse(year + "-"+month+ "-" + day);
	}
	
	public static void main(String[] args) {
		System.out.println(NoliUtils.getNoliDate(DateUtils.getNow()));
